...
def sample_non_edges(hash_edges, N, N_edges, ratio):
    ...
    for i in range(N_non_edges): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! not parallel !!!!!!!!!!!!!!!!!!!!!!
...
def get_node_neighbor_dict(edges, N):
    node_neighbors_dict = {}
    for i in range(edges.shape[1]): #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! not parallel !!!!!!!!!!!!!!!!!!!!!!
        a,b = edges[:,i]
...
def initialize_beta(A_real, prediction_label=None, K=10, beta_init=0.5):
    """
    Initialise one beta prior. If there are labels use them to give a better initialisation of beta else 
    """
    ...
    if prediction_label is not None:
        ...
        initial_beta = np.ones(K) * beta_init
    return initial_beta
