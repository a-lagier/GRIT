'''
    The RRWP MMSBM encoder for GRIT
'''
import torch
...
@register_node_encoder('rrwp_mmsbm_linear')
class RRWPMMSBMLinearNodeEncoder(torch.nn.Module):
    """
...
@register_edge_encoder('rrwp_mmsbm_linear')
class RRWPMMSBMLinearEdgeEncoder(torch.nn.Module):
    '''
